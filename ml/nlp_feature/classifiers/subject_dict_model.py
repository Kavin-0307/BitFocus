...
file=open(r"D:\Python\project_root\data\subjects-representation.json",'r');
...
def exception_unknown(subject):
    ...
    with open(r"D:\Python\project_root\data\subjects-representation.json", "w") as f:
